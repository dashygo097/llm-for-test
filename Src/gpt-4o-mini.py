...
# reinforced 4-shot learning (data from trainset)
data = {
    "text": [
...
testset = dataset["test"].shard(num_shards=125, index=0)
...
# zero-shot accuracy: 0.94
# 2-shot accuracy: 0.94
# 4-shot accuracy: 0.93
# reinforced 4-shot accuracy: 0.945

# I suppose there may be some "very mixed opinions" or "very unclear comments" on this movie
# Well it is also possible that the prompt + examples are too weak to bring any
# help to the predictions by gpt-4o-mini.

# Well, more specific and strong n-shot examples may help increase the accuracy of predictions.
# (See reinforced 4-shot data)
